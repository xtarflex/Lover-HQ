...
export default function Chat() {
  ...
  const handleDownloadImage = async (url) => {
    try {
      ...
      img.src = url; // Not strictly necessary to sanitize img.src for XSS context, but doing so provides defense-in-depth if desired. Keeping as is since browser handles image loading securely.
    } catch (err) {
