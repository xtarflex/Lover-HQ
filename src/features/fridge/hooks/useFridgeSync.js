  ...
  useEffect(() => {
    const runCompaction = async () => {
      ...
      try {
        ...
        // ⚡ Bolt: Use Date.parse() instead of new Date() in the filter loop to avoid allocating Date objects on every iteration, significantly improving performance for large arrays.
